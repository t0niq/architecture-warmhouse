...
1. **Домен**: Управление отоплением (HeatingManagement)\
   **Контекст**:
   - Управление включением/выключением отопления (включить обогрев при падении температуры ниже установленной)
   - Установка целевой температуры
   - Проверка текущей температуры через запрос к датчику

2. **Домен**: Управление устройствами (DeviceManagement)\
   **Контекст**:
   ...
   - Ручное подключение устройств через техника

3. **Домен**: Пользовательское управление (через техников) (UserAccessManagement)\
   **Контекст**:
   - Регистрация пользователей
   - Авторизация в приложении
   - Привязка пользователя к дому и его устройствам
